...
//    private static int z3 = 69;
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(squareArea(8.8));
    	System.out.println(squarePerimeter(5.4));
    	System.out.println(rectangleArea(5.4, 2.1));
    	System.out.println(rectanglePerimeter(5.4, 5.1));
    	System.out.println(zoneOfASphere(3.8, 1.6, 8.8));
    	System.out.println(sphereWithCylinder(5.3));
    	System.out.println(ungula(3.6, 2.5));
